...
import { CallSplit as ParallelIcon } from '@mui/icons-material';

const ParallelNode = ({ data, id }) => {
  // Add defensive checks for data
  if (!data) {
    console.error('ParallelNode received undefined data', { id });
    return (
  ...
  return (
    ...
    >
      ...
      <Box sx={{ backgroundColor: '#ffffff', color: '#374151', p: 2, minHeight: 60, position: 'relative' }}>
        ...
        >
          All outgoing branches will execute in parallel
        </Typography>
      </Box>
